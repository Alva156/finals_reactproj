...
function Login() {
    return (
        <div className="login-container" style={{ backgroundImage: 'url(/images/Home2.png)', backgroundSize: 'cover' }}>
            <NavbarNew />
    ...
    return (
        <div>
            <div className="d-flex row text-white justify-content-center">
                <div className="col-12 login-main-text text-center">
                    LOGIN
                </div>
                <Form className="px-4">
                    ...
                    <div className="d-flex justify-content-center col mt-3">
                            ...
                            Don’t have an account yet? <span className="font-underline">Register here.</span> 
                            </div>
                    </div>
