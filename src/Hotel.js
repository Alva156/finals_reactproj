...
function Hotel() {
    return (
        <div style={{backgroundImage: 'url(/images/Home2.png)', backgroundSize: 'cover', backgroundAttachment:'fixed'}}>
            <NavbarNew />
...
function Search() {
    return (
        <div >
            <Card className='mb-2'>
                <Card.Body>
                    <Card.Title className='px-3'><BiSolidBuildingHouse style={{ fontSize: '25px' }} />HOTELS</Card.Title>
                            ...
                            <div className='container-fluid m-0 '>
                                <div className='row gap-4 d-flex flex-wrap'>
                                    <div className='inputs px-4 py-1 col-md-3 '>
                                        ...
                                        <div>
                                            <input className='input-text form-control-plaintext' type='text' placeholder='email@example.com' />
                                        </div>
                                    </div>
                                    <div className='inputs px-4 py-1 d-flex flex-column flex-md-row gap-4 col-md-2'>
                                        <div>
                                            ...
                                            <div>
                                                <input className='input-text form-control-plaintext text-secondary fs-smaller overflow-auto' type='date' placeholder='Fri, 15 March' />
                                            </div>
                                        </div>
                                    ...
                                    <div className='inputs px-4 py-1 col-md-3'>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-10'>
                                                <input className='input-text form-control-plaintext fs-smaller' type='text' placeholder='1 Adult(s), 0 Child, 1 Room' />
                                            </div>
                                        </div>
...
function HotelHead() {
    return (
        <div>
            <div class="list-head d-flex p-2 text-white my-4 px-4">LOWEST PRICE GUARANTEED!</div>
        </div>
    )
}
            ...
            <div className='row p-2 rounded d-flex flex-wrap'>
                ...
                <div className='col list-all-details'>
                    <div className='col-12 row list-detail d-flex justify-content-center align-items-center'>
                        <div className='col-md-9 list-name'>
                            HOTEL NAME
                        </div>
